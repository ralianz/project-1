...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 db-head">
				<h2>Browse Contract</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod<br>
									tempor incididunt ut labore et dolore magna aliqua. Ut enim</p>
			</div>
			
			<div class="col-md-12 col-sm-12">
				<h4 style="font-family: 'Roboto', sans-serif; font-weight: 300;">Ketenagakerjaan</h4>
			</div>
			
			<div class="col-md-12 col-sm-12 col-xs-12 template-ctr">
				<div class="col-md-3 col-sm-12 template-scr-wrap">
					<div class="col-md-12 col-sm-12 tenagakerja-templates">
						<div class="col-md-4">
						<img src="assets/image/ketenagakerjaan.png">
						</div>
						<div class="col-md-8">
						<h5>Perjanjian Karyawan Kontrak</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
						<button type="button" class="btn btn-primary btn-select">select</button>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-12 template-ctr-wrap">
					<div class="col-md-12 col-sm-12 tenagakerja-templates">
						<div class="col-md-4">
						<img src="assets/image/ketenagakerjaan.png">
						</div>
			...
			<div class="col-md-12 recently">
				<h4 style="font-family: 'Roboto', sans-serif; font-weight: 300;">Kerahasiaan dan Non-Kompetisi</h4>
			</div>
			
			<div class="col-md-12 col-sm-12 col-xs-12  template-scr">
				<div class="col-sm-6 col-xs-12 template-scr-wrap">
					<div class="col-md-4 rahasia-templates">
						<img src="assets/image/kerahasiaan.png">
					</div>
					<div class="col-md-8 secret-templates-caption">
						<h5>Perjanjian Karyawan Kontrak</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
						<button type="button" class="btn btn-primary btn-select">select</button>
					</div>
			...
			<div class="col-md-12 recently">
				<h4 style="font-family: 'Roboto', sans-serif; font-weight: 300;">Pinjam Meminjam</h4>
			</div>
			
			<div class="col-md-12 col-sm-12 col-xs-12  template-ctr">
				<div class="col-sm-6 col-xs-12 template-ctr-wrap">
					<div class="col-md-4 tenagakerja-templates">
						<img src="assets/image/ketenagakerjaan.png">
					</div>
					<div class="col-md-8 employee-templates-caption">
						<h5>Perjanjian Karyawan Kontrak</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
						<button type="button" class="btn btn-primary btn-select">select</button>
					</div>
			...
			<div class="col-md-12 recently">
				<h4 style="font-family: 'Roboto', sans-serif; font-weight: 300;">Sewa Menyewa</h4>
			</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12" style="border-bottom: 2px solid #eee; height: 50px;">
